...
"background-image: url(:/bg/graphpg2.jpeg);}")
        ...
        self.comboBox_D1 = QtWidgets.QComboBox(self.widget)
        self.comboBox_D1.setGeometry(QtCore.QRect(650, 130, 130, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.comboBox_D1.setFont(font)
        self.comboBox_D1.setObjectName("comboBox_D1")
        self.comboBox_D1.addItem("")
        self.comboBox_D1.addItem("")
        self.comboBox_D1.addItem("")
        self.comboBox_D1.addItem("")
        self.comboBox_D1.addItem("")
        self.comboBox_D1.addItem("")
        self.comboBox_D2 = QtWidgets.QComboBox(self.widget)
        self.comboBox_D2.setGeometry(QtCore.QRect(840, 130, 130, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.comboBox_D2.setFont(font)
        self.comboBox_D2.setObjectName("comboBox_D2")
        self.comboBox_D2.addItem("")
        self.comboBox_D2.addItem("")
        self.comboBox_D2.addItem("")
        self.comboBox_D2.addItem("")
        self.comboBox_D2.addItem("")
    ...
    def retranslateUi(self, graph):
        ...
        self.comboBox.setItemText(4, _translate("graph", "SHIB"))
        self.graphbtn.setText(_translate("graph", "Generate"))
        self.comboBox_D1.setItemText(0, _translate("graph", "2016"))
        self.comboBox_D1.setItemText(1, _translate("graph", "2017"))
        self.comboBox_D1.setItemText(2, _translate("graph", "2018"))
        self.comboBox_D1.setItemText(3, _translate("graph", "2019"))
        self.comboBox_D1.setItemText(4, _translate("graph", "2020"))
        self.comboBox_D1.setItemText(5, _translate("graph", "2021"))
        self.comboBox_D2.setItemText(0, _translate("graph", "2017"))
        self.comboBox_D2.setItemText(1, _translate("graph", "2018"))
        self.comboBox_D2.setItemText(2, _translate("graph", "2019"))
        self.comboBox_D2.setItemText(3, _translate("graph", "2020"))
        self.comboBox_D2.setItemText(4, _translate("graph", "2021"))
        self.comboBox_D2.setItemText(5, _translate("graph", "2022"))

    def storeval(self):
        self.crypval = self.comboBox.currentText()
        self.id1=self.comboBox_D1.currentText()
        self.id2=self.comboBox_D2.currentText()
